...
class RoomsScenario(BaseScenario[RoomsScenarioConfig, dict[str, NDArray[np.float64]]]):
    def __init__(
        ...
        self.goal_thr_dist: float = (
            config.spawn_config.goal_size + config.spawn_config.agent_size / 3
        )
        self.lava_thr_dist: float = (
            config.spawn_config.lava_size + config.spawn_config.agent_size / 3
        )
        self.hole_thr_dist: float = (
            config.spawn_config.hole_size + config.spawn_config.agent_size / 3
        )
